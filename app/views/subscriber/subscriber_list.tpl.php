	...
	<div class="panel panel-default">
		<div class="panel-head">
			...
			<div class="panel-action">
				<a href="<?php echo URL.DIR_ROUTE.'subscriber/add'; ?>" class="btn btn-primary btn-gradient btn-pill btn-sm"><i class="icon-plus mr-1"></i> <?php echo $lang['users']['text_new_subscriber']; ?></a>
			</div>
		</div>
				...
				<table class="table table-bordered table-striped datatable-table" width="100%">
					...
					<tbody>
						...
						<tr>
							...
							<td><p class="font-14 margin-0"><?php echo $value['email'];?></p></td>
							<td>
							...
							<td class="table-action">
								<a href="index.php?route=subscriber/edit&id=<?php echo $value['id']; ?>" class="btn btn-primary btn-circle btn-outline btn-outline-1x" data-toggle="tooltip" title="<?php echo $lang['common']['text_edit']; ?>"><i class="icon-pencil"></i></a>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<form action="<?php echo URL.DIR_ROUTE.'subscriber/delete'; ?>" class="delete-card-button" method="post">
