    ...
    <div class="panel panel-default">
        <div class="panel-head">
            ...
            <div class="panel-action">
                <a href="<?php echo URL.DIR_ROUTE.'lead/add'; ?>"
                    class="btn btn-primary btn-outline btn-gradient btn-pill btn-sm"><i class="icon-plus mr-1"></i>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span
                                        class="badge badge-light badge-pill badge-sm"><?php echo $lang['common']['text_new']; ?></span>
                                    <?php } elseif ($value['status'] == "2") { ?>
                                    <span
                                        class="badge badge-light badge-pill badge-sm"><?php echo $lang['contact']['text_attempted']; ?></span>
                                    <?php } elseif ($value['status'] == "3") { ?>
                                    <span
                                        class="badge badge-light badge-pill badge-sm"><?php echo $lang['contact']['text_not_attempted']; ?></span>
                                    <?php } elseif ($value['status'] == "4") { ?>
                                    <span
                                        class="badge badge-light badge-pill badge-sm"><?php echo $lang['contact']['text_working']; ?></span>
                                    <?php } elseif ($value['status'] == "5") { ?>
                                    <span
                                        class="badge badge-light badge-pill badge-sm"><?php echo $lang['contact']['text_contacted']; ?></span>
                                    <?php } elseif ($value['status'] == "6") { ?>
                                    <span
                                        class="badge badge-light badge-pill badge-sm"><?php echo $lang['contact']['text_converted_qualified']; ?></span>
                                    <?php } elseif ($value['status'] == "7") { ?>
                                    <span
                                        class="badge badge-light badge-pill badge-sm"><?php echo $lang['contact']['text_disqualified']; ?></span>
                                    <?php } ?>
                                </td>
                                ...
                                <td class="table-action">
                                    <a href="#" class="btn btn-primary btn-circle btn-outline btn-outline-1x p-2"
                                        data-toggle="modal" data-target="#example<?php echo $values['user_id']; ?>"><i
                                            class="fa fa-users"></i></a>
                                    <a href="<?php echo URL.DIR_ROUTE . 'lead/edit&id=' .$value['id']; ?>"
                                        class="btn btn-primary btn-circle btn-outline btn-outline-1x p-2" data-toggle="tooltip"
                                        title="<?php echo $lang['common']['text_edit']; ?>"><i class="icon-pencil"></i></a>
                                    <p class="btn btn-danger btn-circle btn-outline btn-outline-1x table-delete p-2"
                                        data-toggle="tooltip" title="<?php echo $lang['common']['text_delete']; ?>"><i
                                            class="icon-trash"></i><input type="hidden" value="<?php echo $value['id']; ?>">
                                    </p>
                                </td>
                                <td>
                                    <?php
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="<?php echo URL.DIR_ROUTE.'lead/delete'; ?>" class="delete-card-button" method="post">
                    ...
                    <button type="submit" class="btn btn-danger btn-gradient btn-pill"
                        name="delete"><?php echo $lang['common']['text_delete']; ?></button>
                </form>
                <button type="button" class="btn btn-default btn-gradient btn-pill"
                    data-dismiss="modal"><?php echo $lang['common']['text_close']; ?></button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="example<?php echo $values['user_id']; ?>" tabindex="-1" role="dialog"
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <div class="col-md-10 customer-search">
                            ...
                            <select name="staff_ff" class="selectpicker" data-width="100%" data-live-search="true"
                                title="Assign Staff">
                                <?php if ($staff){ foreach ($staff as $key => $values) { ?>
                                <option value="<?php echo $values['user_id']; ?>"
                                    <?php if ($result['user_id'] == $values['user_id']) { echo "selected"; } ?>>
