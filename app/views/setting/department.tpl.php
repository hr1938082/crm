    ...
    <div class="panel panel-default">
        <div class="panel-head">
            ...
            <div class="panel-action">
                <a class="btn btn-primary btn-outline btn-gradient btn-pill btn-sm" data-toggle="modal" data-target="#addDepartmentModal"><i class="icon-plus mr-1"></i> <?php echo $lang['settings']['text_new_department']; ?></a>
            </div>  
        </div>
                    ...
                    <tbody>
                        ...
                        <tr> 
                            ...
                            <td class="table-action">
                                <a class="btn btn-primary btn-circle btn-outline btn-outline-1x edit-department" data-toggle="tooltip" title="<?php echo $lang['common']['text_edit']; ?>" data-name="<?php echo $value['name'] ?>" data-id="<?php echo $value['id'] ?>" data-status="<?php echo $value['status'] ?>"><i class="icon-pencil"></i></a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="<?php echo URL.DIR_ROUTE.'department/delete'; ?>" class="delete-card-button" method="post">
...
<div class="modal fade" id="addDepartmentModal" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><?php echo $lang['settings']['text_new_department']; ?></h5>
            ...
            <form action="<?php echo $action; ?>" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-form-label"><?php echo $lang['settings']['text_department_name']; ?></label>
                        <input type="text" class="form-control" name="name" placeholder="<?php echo $lang['settings']['text_department_name']; ?>" required>
                    </div>
                    <div class="form-group">
...
<script>
    $(document).ready(function () {
        ...
        $('body').on('click', '.edit-department', function () {
            ...
            $('#addDepartmentModal .modal-title').text('<?php echo $lang['settings']['text_edit_department'] ?>');
            $('#addDepartmentModal').modal('show');
        });

        $('#addDepartmentModal').on('hidden.bs.modal', function (e) {
            $('#addDepartmentModal .modal-title').text('<?php echo $lang['settings']['text_new_department'] ?>');
