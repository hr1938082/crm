            ...
            <div class="panel panel-default">
                <div class="panel-head">
                    ...
                    <div class="panel-action">
                        <a class="btn btn-primary btn-outline btn-gradient btn-pill btn-sm" data-toggle="modal" data-target="#addTaxModel"><i class="icon-plus mr-1"></i> <?php echo $lang['settings']['text_new_tax']; ?></a>
                    </div>  
                </div>
                                ...
                                <?php if ($result) { foreach ($result as $key => $value) { ?>
                                    <tr> 
                                        ...
                                        <td class="table-action">
                                            <a class="btn btn-primary btn-circle btn-outline btn-outline-1x edit-tax" data-toggle="tooltip" title="<?php echo $lang['common']['text_edit']; ?>" data-name="<?php echo $value['name'] ?>" data-rate="<?php echo $value['rate'] ?>" data-id="<?php echo $value['id'] ?>">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="<?php echo URL.DIR_ROUTE.'tax/delete'; ?>" class="delete-card-button" method="post">
            ...
            <form action="<?php echo $action; ?>" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-form-label"><?php echo $lang['settings']['text_tax_name']; ?></label>
                        <input type="text" class="form-control" name="name" placeholder="<?php echo $lang['settings']['text_tax_name']; ?>">
                    </div>
                    <div class="form-group">
                        <label class="col-form-label"><?php echo $lang['settings']['text_rate']; ?> (%)</label>
