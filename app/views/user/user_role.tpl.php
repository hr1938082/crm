	...
	<div class="panel panel-default">
		<div class="panel-head">
			...
			<div class="panel-action">
				<a href="<?php echo URL.DIR_ROUTE . 'role/add'; ?>" class="btn btn-primary btn-gradient btn-pill btn-sm"><i class="icon-plus mr-1"></i> <?php echo $lang['users']['text_new_user_role']; ?></a>
			</div>
		</div>
					...
					<tbody>
						...
						<tr>
							...
							<td class="table-action">
								<?php if ($value['id'] != "1") { ?>
								<a href="index.php?route=role/edit&id=<?php echo $value['id']; ?>" class="btn btn-primary btn-circle btn-outline btn-outline-1x" data-toggle="tooltip" title="<?php echo $lang['common']['text_edit']; ?>"><i class="icon-pencil"></i></a>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<form action="<?php echo URL.DIR_ROUTE.'role/delete'; ?>" class="delete-card-button" method="post">
