...
<body>
	<div class="inv-template inv-template-1">
		...
		<div class="strip"><p><?php echo $data['lang']['quotes']['text_quotation']; ?></p></div>
						...
						<td class="v-align-top pr-30">
							<div class="total">
								<table cellspacing="0">
									<tbody>
										<tr>
											<td><?php echo $data['lang']['quotes']['text_sub_total']; ?></td>
											<td><?php echo $result['currency_abbr'].$result['total']['subtotal']; ?></td>
										</tr>
										<tr>
											<td><?php echo $data['lang']['quotes']['text_tax']; ?></td>
											<td><?php echo $result['currency_abbr'].$result['total']['tax']; ?></td>
										</tr>
										<tr>
											<td><?php echo $data['lang']['quotes']['text_discount']; ?></td>
											<td><?php echo $result['currency_abbr'].$result['total']['discount_value']; ?></td>
										</tr>
										<tr class="main">
											<td><?php echo $data['lang']['quotes']['text_total']; ?></td>
											<td><?php echo $result['currency_abbr'].$result['total']['amount']; ?></td>
										</tr>
									</tbody>
								</table>
							</div>
