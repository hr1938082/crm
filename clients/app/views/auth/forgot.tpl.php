			...
			<div id="login-form" class="lgn-form ">
				<form class="form-vertical" action="<?php echo $action ?>" method="post">
					...
					<div class="lgn-input form-group">
						...
						<div class="col-sm-12">
							<input class="form-control" type="email" name="mail" id="lgn-mail" placeholder="<?php echo $lang['common']['text_email_address']; ?>" autocomplete="off" required>
						</div>
					</div>
					...
					<div class="lgn-submit">
						<button type="submit" id="forgot-submit" class="btn btn-primary btn-pill btn-lg" name="forgot"><?php echo $lang['login']['text_send_reset_link']; ?></button>
					</div>
				</form>
			</div>
