...
<body>
	...
	<div class="lgn-background">
		<div class="lgn-wrapper rgr-wrapper">
			...
			<div id="login-form" class="lgn-form ">
				<form class="form-vertical" action="<?php echo $action ?>" method="post">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="lgn-input form-group">
								<label class="control-label col-sm-12"><?php echo $lang['common']['text_first_name']; ?></label>
								<div class="col-sm-12">
									<input class="form-control" type="text" name="fname" id="lgn-name" placeholder="Enter <?php echo $lang['common']['text_first_name']; ?>" autocomplete="off" required>
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="lgn-input form-group">
								<label class="control-label col-sm-12"><?php echo $lang['common']['text_last_name']; ?></label>
								<div class="col-sm-12">
									<input class="form-control" type="text" name="lname" id="lgn-name" placeholder="Enter <?php echo $lang['common']['text_last_name']; ?>" autocomplete="off" required>
								</div>
							</div>
						</div>
					</div>
					<div class="row">
						...
						<div class="col-md-6">
							<div class="lgn-input form-group">
								<label class="control-label col-sm-12"><?php echo $lang['common']['text_mobile_number']; ?></label>
								<div class="col-sm-12">
									<input class="form-control" type="number" name="mobile" id="lgn-number" placeholder="Enter <?php echo $lang['common']['text_mobile_number']; ?>" autocomplete="off" required>
								</div>
							</div>
						</div>
					</div>
	...
	<script type="text/javascript" id="cookieinfo" src="//cookieinfoscript.com/js/cookieinfo.min.js" data-bg="#282a3c" data-fg="#FFFFFF" data-link="#F1D600" data-cookie="cllientCookieInfo" data-text-align="left" data-close-text="<?php echo $lang['login']['text_cookie_close_text']; ?>" data-message="<?php echo $lang['login']['text_cookie_message']; ?>"></script>
