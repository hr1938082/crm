		...
		<div class="company pl-30 pr-30">
			<table>
				<tbody>
					<tr>
						<td class="info">
							<div class="logo"><img src="<?php echo '../public/images/logo-color.png'; ?>" alt="logo"></div>
			...
			<div class="bottom pr-30">
				<table>
					<tbody>
						<tr>
							<td class="sign">
								<?php if (!empty($data['info']['signature']) && file_exists(DIR.'public/uploads/'.$data['info']['signature'])) { ?>
									<img src="<?php echo DIR.'/public/uploads/'.$data['info']['signature']; ?>">
								<?php } else { ?>
